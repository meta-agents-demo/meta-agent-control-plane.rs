    ...
    let body = view! {
        <main class="shell">
            <header>
                ...
                <nav aria-label="Analytics views"><a href="/">"Overview"</a><a href="/bridge">"Bridge"</a><a href="/runtime">"Runtime"</a><a href="/explorer">"Explorer"</a><a href="/metacognition">"Metacognition"</a></nav>
            </header>
