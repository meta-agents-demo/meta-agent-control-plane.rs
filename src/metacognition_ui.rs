...
nav{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}nav a{color:var(--accent);text-decoration:none;border:1px solid var(--line);padding:10px 14px;border-radius:10px}@media(max-width:620px){nav{justify-content:flex-start;margin-top:12px}}
"#;
...
mod tests {
    ...
    #[test]
    fn renders_complete_analytics_navigation() {
